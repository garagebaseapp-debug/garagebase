...
export default function DomovPage() {
  ...
  return (
    <div className={`gb-app-home mx-auto min-h-screen w-full max-w-none px-0 pb-[calc(7.4rem+env(safe-area-inset-bottom))] pt-0 sm:px-0 xl:pl-[280px] xl:pb-12 ${isLightTheme ? 'bg-[#f1f3fb] text-[#101225]' : 'bg-[#151b2d] text-white'}`}>
      <div className="mx-auto w-full max-w-none">
        <section className={`relative mx-4 mb-5 mt-4 min-h-[44svh] overflow-hidden rounded-[30px] shadow-2xl ${isLightTheme ? 'bg-[#e9edf8] shadow-[0_24px_60px_rgba(69,77,115,0.18)]' : 'bg-[#1b2236] shadow-[0_24px_60px_rgba(6,10,24,0.28)]'} xl:mx-0 xl:mb-8 xl:mt-0 xl:h-[390px] xl:min-h-0 xl:rounded-[34px]`}>
          <picture>
          ...
          <div className={`absolute inset-0 ${isLightTheme ? 'bg-gradient-to-r from-[#f1f3fb]/86 via-[#f1f3fb]/18 to-transparent' : 'bg-gradient-to-r from-[#182033]/62 via-[#182033]/14 to-transparent'}`} />
        ...
        <section className="mx-auto grid w-full gap-5 px-4 xl:w-auto xl:max-w-6xl xl:grid-cols-2 xl:gap-8 xl:px-0">
          <div>
            ...
            <div className={`overflow-hidden rounded-[18px] shadow-[0_8px_22px_rgba(16,18,37,0.06)] xl:rounded-[24px] ${isLightTheme ? 'border border-[#ffffff]/90 bg-[#fbfbff]/88 shadow-[0_16px_36px_rgba(69,77,115,0.14)]' : 'border border-[#3b4664] bg-[#1b2236]/92 shadow-[0_18px_42px_rgba(6,10,24,0.26)]'}`}>
          ...
          <div className="hidden xl:block">
            ...
            <div className="grid grid-cols-2 gap-3">
              {quickActions.map((item) => (
                <button key={item.label} onClick={() => router.push(item.href)} className={`flex min-h-[105px] items-center gap-4 rounded-[22px] border p-5 text-left text-lg font-black ${isLightTheme ? 'border-[#ffffff]/80 bg-[#fbfbff]/82 text-[#101225] shadow-xl shadow-[#454d73]/12' : 'border-[#3b4664] bg-[#1b2236]/88 text-white shadow-xl shadow-[#060a18]/18'}`}>
