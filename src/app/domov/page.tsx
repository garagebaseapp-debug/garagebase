  ...
  return (
    <div className={`gb-app-home mx-auto min-h-screen w-full max-w-none px-0 pb-[calc(7.4rem+env(safe-area-inset-bottom))] pt-0 sm:px-0 xl:pl-[280px] xl:pb-12 ${isLightTheme ? 'bg-[#f1f3fb] text-[#101225]' : 'bg-[#130f1d] text-white'}`}>
      <div className="mx-auto w-full max-w-none">
        <section className={`relative mx-4 mb-5 mt-4 min-h-[44svh] overflow-hidden rounded-[30px] border-b shadow-2xl ${isLightTheme ? 'border-[#d9def0] bg-[#e9edf8] shadow-[0_24px_60px_rgba(69,77,115,0.18)]' : 'border-[#6d57a2] bg-[#1c1730] shadow-[0_28px_64px_rgba(4,3,12,0.36),0_1px_0_rgba(196,181,253,0.18)]'} xl:mx-0 xl:mb-8 xl:mt-0 xl:h-[390px] xl:min-h-0 xl:rounded-[34px]`}>
          <picture>
          ...
          <div className={`absolute inset-0 ${isLightTheme ? 'bg-gradient-to-r from-[#f1f3fb]/86 via-[#f1f3fb]/18 to-transparent' : 'bg-gradient-to-r from-[#15101f]/50 via-[#15101f]/12 to-transparent'}`} />
            ...
            <header className="flex items-center justify-between xl:absolute xl:left-12 xl:right-12 xl:top-10 xl:mb-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border shadow-lg transition-colors xl:h-12 xl:w-12 ${
                    isLightTheme
                      ? 'border-[#fde68a] bg-[#facc15] text-[#422006] shadow-[#facc15]/28'
                      : 'border-[#8b7cf6]/55 bg-[#25185a] text-[#d8d4ff] shadow-black/20'
                  }`}
                >
                  {isLightTheme ? (
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5 xl:h-6 xl:w-6">
        ...
        <section className="mx-auto grid w-full gap-5 px-4 xl:w-auto xl:max-w-6xl xl:grid-cols-2 xl:gap-8 xl:px-0">
          <div>
            ...
            <div className={`overflow-hidden rounded-[18px] shadow-[0_8px_22px_rgba(16,18,37,0.06)] xl:rounded-[24px] ${isLightTheme ? 'border border-[#ffffff]/90 bg-[#fbfbff]/88 shadow-[0_16px_36px_rgba(69,77,115,0.14)]' : 'border border-[#5b4a86] bg-[#1c1730]/94 shadow-[inset_0_1px_0_rgba(196,181,253,0.08),0_18px_42px_rgba(4,3,12,0.28)]'}`}>
          ...
          <div className="hidden xl:block">
            ...
            <div className="grid grid-cols-2 gap-3">
              {quickActions.map((item) => (
                <button key={item.label} onClick={() => router.push(item.href)} className={`flex min-h-[105px] items-center gap-4 rounded-[22px] border p-5 text-left text-lg font-black ${isLightTheme ? 'border-[#ffffff]/80 bg-[#fbfbff]/82 text-[#101225] shadow-xl shadow-[#454d73]/12' : 'border-[#5b4a86] bg-[#1c1730]/92 text-white shadow-[inset_0_1px_0_rgba(196,181,253,0.08),0_18px_38px_rgba(4,3,12,0.24)]'}`}>
