        ...
        <script dangerouslySetInnerHTML={{__html: `
          ...
          try {
            ...
            const normalizeFont = (value, version) => {
              ...
              if (typeof value === 'number' && value >= 360) return 400;
              ...
              if (value === 'extra-velika' || value === 'najvecja') return 400;
              return 140;
            };
            const nextFont = normalizeFont(n.pisava, n.fontPresetVersion);
            const rootPx = nextFont === 100 ? 14.5 : nextFont === 120 ? 15.25 : nextFont === 160 ? 16.75 : nextFont === 300 ? 22 : nextFont === 400 ? 25 : 16;
