        ...
        <script dangerouslySetInnerHTML={{__html: `
          ...
          try {
            ...
            const normalizeFont = (value, version) => {
              ...
              if (value === 120 || value === 140 || value === 160 || value === 600) return value;
              if (value === 300) return explicitExtraScale ? 300 : 600;
              if (value === 400) return 600;
              ...
              if (typeof value === 'number' && value >= 360) return 600;
              ...
              if (value === 'zelo-velika') return 300;
              if (value === 'extra-velika' || value === 'najvecja') return 600;
              return 140;
            };
            const nextFont = normalizeFont(n.pisava, n.fontPresetVersion);
            const rootPx = nextFont === 100 ? 14.5 : nextFont === 120 ? 15.25 : nextFont === 160 ? 16.75 : nextFont === 300 ? 22 : nextFont === 600 ? 29 : 16;
