...
const glavnePovezave = [
  { key: 'garaza', href: '/garaza', icon: '🏠', label: 'Garaža' },
  { key: 'gorivo', href: '/vnos-goriva', icon: '⛽', label: 'Gorivo' },
  { key: 'servis', href: '/vnos-servisa', icon: '🔧', label: 'Servis' },
  { key: 'stroski', href: '/stroski-garaza', icon: '📊', label: 'Stroški' },
  { key: 'nastavitve', href: '/nastavitve', icon: '⚙️', label: 'Več' },
]
