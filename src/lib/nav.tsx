...
export function BottomNav({ aktivna }: { aktivna?: string }) {
  ...
  return (
    <>
      ...
      <div className="gb-mobile-nav fixed bottom-0 left-1/2 right-auto z-50 flex w-full max-w-[36rem] -translate-x-1/2 justify-between border-t border-[#1a1a28] bg-[#0a0a12]/96 px-2 pb-2 pt-3 backdrop-blur-xl">
        {mobileLinks.map((item: any) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-[13.5px] font-black leading-none ${isActive ? 'text-[#6c63ff]' : 'text-[#343a46]'}`}>
