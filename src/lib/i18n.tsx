...
const phrasePairs: Array<[string, string]> = [
  ...
  ['Launch promocija', 'Launch promotion'], ['V obdobju testiranja so vse funkcije GarageBase odklenjene brez doplačila do 31. 12. 2026. Po tem datumu bodo napredne funkcije lahko del plačljivih paketov; uporabnike bomo o paketih in cenah obvestili vnaprej.', 'During the testing period all GarageBase features are unlocked at no extra charge until 31 Dec 2026. After that date, advanced features may become part of paid plans; users will be notified about plans and prices in advance.'], ['Zasebnost', 'Privacy'], ['Pogoji uporabe', 'Terms'],
  ['Nazaj na GarageBase', 'Back to GarageBase'], ['Velja v obdobju beta/lansiranja.', 'Applies during the beta/launch period.'], ['Promocijski povzetek', 'Promotion summary'], ['V obdobju lansiranja so funkcije GarageBase odklenjene brez doplačila do 31. 12. 2026, v okviru poštene uporabe.', 'During the launch period, GarageBase features are unlocked at no extra charge until 31 Dec 2026, within fair use.'],
  ['Kaj pomeni odklenjeno do 31. 12. 2026', 'What unlocked until 31 Dec 2026 means'], ['Uporabniki lahko v obdobju promocije uporabljajo javno dostopne funkcije GarageBase brez doplačila. To ne pomeni neomejene porabe strežnikov, slik, izvoza, avtomatizacije ali prihodnjih funkcij.', 'During the promotion, users can use publicly available GarageBase features at no extra charge. This does not mean unlimited use of servers, images, exports, automation or future features.'],
  ['Poštena uporaba', 'Fair use'], ['GarageBase lahko zaradi varnosti, zlorab, tehničnih omejitev ali izjemno visoke porabe uvede razumne tehnične omejitve, kot so omejitve slik, izvozov, QR prenosov, števila vozil, API klicev ali podobnih virov.', 'For safety, abuse prevention, technical limits or exceptionally high usage, GarageBase may apply reasonable technical limits such as limits on images, exports, QR transfers, vehicle count, API calls or similar resources.'],
  ['AI/OCR ni del javne beta obljube', 'AI/OCR is not part of the public beta promise'], ['AI/OCR branje računov je v internem testiranju in planirano za javno lansiranje v letu 2027. Funkcija je lahko kasneje del plačljivih paketov ali omejena z mesečnimi limiti.', 'AI/OCR receipt reading is in internal testing and planned for public launch in 2027. The feature may later be part of paid plans or limited by monthly quotas.'],
  ['Plačljivi paketi po promociji', 'Paid plans after the promotion'], ['Po 31. 12. 2026 bodo lahko napredne funkcije del plačljivih paketov. Uporabnike bomo o paketih, cenah in spremembah obvestili vnaprej.', 'After 31 Dec 2026, advanced features may become part of paid plans. Users will be notified about packages, pricing and changes in advance.'],
  ['Spremembe promocije', 'Promotion changes'], ['GarageBase si pridržuje pravico prilagoditi promocijske pogoje, če je to potrebno zaradi varnosti, zlorab, stroškov infrastrukture, pravnih zahtev ali stabilnosti storitve.', 'GarageBase reserves the right to adjust promotion terms if needed for safety, abuse prevention, infrastructure costs, legal requirements or service stability.'],
